...
if __name__ == "__main__":
    ...
    parser.add_argument("--set_ins_id", type=str,default="off", help="path to label file")
    ...
    for x,(image_path,labels_path) in enumerate(zip(image_path_1,label_path_1)):
        ...
        # NumPy配列のリストをPyTorchのTensorに変換する
        try:
...
#         pred_phrases = ["cellphone", "cellphone", "cellphone", "cellphone", "cellphone","cellphone"]
